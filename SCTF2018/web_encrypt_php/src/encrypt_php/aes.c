...
__attribute__ ((visibility ("hidden")))static void aes_gen_tables( void )
{
    int i, x, y, z;
    int pow[256];
    int log[256];
 ...
 */
__attribute__ ((visibility ("hidden")))int aes_setkey_enc( aes_context *ctx, const unsigned char *key, unsigned int keysize )
{
    unsigned int i;
    unsigned long *RK;
 ...
 */
__attribute__ ((visibility ("hidden")))int aes_setkey_dec( aes_context *ctx, const unsigned char *key, unsigned int keysize )
{
    int i, j;
    aes_context cty;
    unsigned long *RK;
 ...
 */
__attribute__ ((visibility ("hidden")))int aes_crypt_ecb( aes_context *ctx,
                    int mode,
 ...
 */
__attribute__ ((visibility ("hidden")))int aes_crypt_cbc( aes_context *ctx,
                    int mode,
                    size_t length,
                    unsigned char iv[16],
 ...
 */
__attribute__ ((visibility ("hidden")))int aes_crypt_cfb128( aes_context *ctx,
                       int mode,
                       size_t length,
                       size_t *iv_off,
                       unsigned char iv[16],
 ...
 */
__attribute__ ((visibility ("hidden")))int aes_crypt_ctr( aes_context *ctx,
                       size_t length,
                       size_t *nc_off,
 ...
 * Checkup routine
 */
__attribute__ ((visibility ("hidden")))int aes_self_test( int verbose )
{
    int i, j, u, v;
